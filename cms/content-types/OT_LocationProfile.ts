...
export const OT_LocationProfile = contentType({
  ...
  properties: {
    ...
    siteKey: {
      ...
      description:  'The domain of the site this location belongs to — e.g. "your-site.vercel.app". Must match the Front End Domain set in ThemeManager. Used to scope location search results to the correct site.',
      group:        'OT_Content',
      sortOrder:    70,
